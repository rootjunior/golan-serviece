...
const file_internal_transport_grpc_proto_user_proto_rawDesc = "" +
	"\n" +
	"(internal/transport/grpc/proto/user.proto\x12\x04user\"'\n" +
	...
	"\vUserService\x12?\n" +
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x18.user.CreateUserResponseB8Z6go-service/internal/transport/grpc/proto/userpb;userpbb\x06proto3"
